    ...
    public void contextInitialized(ServletContextEvent arg0) {
    	SchedulerFactory sf=new StdSchedulerFactory();
  	    try {
			...
			JobDetail jd=new JobDetail("jobPl","groupPl",ReadDiagnosticPlJob.class);
			//CronTrigger ct=new CronTrigger("cronTriggerPl","groupPl","0 0 4,12,20 * * ?");
			CronTrigger ct=new CronTrigger("cronTriggerPl","groupPl","0 0 1,2 * * ?");
			//CronTrigger ct=new CronTrigger("cronTriggerPl","groupPl","0 42 8 * * ?");
