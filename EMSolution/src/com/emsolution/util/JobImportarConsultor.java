...
public class JobImportarConsultor implements Job{
	...
	public void execute(JobExecutionContext arg0) throws JobExecutionException {
		...
		try {
			...
			SQL="select trim(s.cuno), trim(s.SLMN02), trim(f.SLMNM) from "+IConstantAccess.LIB_DBS+".SCPDIVF0 s, "+IConstantAccess.LIB_DBS+".SCPSMFM0 f"+ 
					" where s.divi = 'G' "+ 
					" and s.SLMT02 = '2' "+ 
					" and f.DIVI = 'G'"+ 
					" and f.SLMT = '2'  "+ 
