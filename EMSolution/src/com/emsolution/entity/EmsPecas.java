 ...
 */
@Entity
@Table(name = "EMS_PECAS")
public class EmsPecas implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof EmsPecas)) {
            return false;
        }
        EmsPecas other = (EmsPecas) object;
    ...
    public String toString() {
        return "com.emsolution.entity.EmsPecas[ id=" + id + " ]";
    }
