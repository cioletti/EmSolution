 ...
 */
@Entity
@Table(name = "EMS_FUEL_BUFFER")
public class EmsFuelBuffer implements Serializable {
	...
	public EmsFuelBuffer() {
    }

    public EmsFuelBuffer(Long buffer) {
        this.buffer = buffer;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof EmsFuelBuffer)) {
            return false;
        }
        EmsFuelBuffer other = (EmsFuelBuffer) object;
