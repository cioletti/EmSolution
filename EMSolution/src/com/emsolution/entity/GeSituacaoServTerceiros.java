...
public class GeSituacaoServTerceiros implements Serializable {
    ...
    @Column(name = "DATA_ENVIO_NOTA_FISCAL")
    @Temporal(TemporalType.TIMESTAMP)
    private Date dataEnvioNotaFiscal;
    @Column(name = "ID_FUNC_ENVIO_NOTA_FISCAL")
    private String idFuncEnvioNotaFiscal;
    @Lob
    @Column(name = "OBS_ENVIO_NOTA_FISCAL")
    private String obsEnvioNotaFiscal;
    
    @OneToMany(mappedBy = "idSituacaoServTerc")
    private Collection<GeSituacaoItem> geSituacaoItemCollection;
    
    @JoinColumn(name = "ID_NATUREZA_OPERACAO", referencedColumnName = "ID")
    @ManyToOne
    private GeNaturezaOperacao idNaturezaOperacao;
	...
	public Date getDataEnvioNotaFiscal() {
		return dataEnvioNotaFiscal;
	}

	public void setDataEnvioNotaFiscal(Date dataEnvioNotaFiscal) {
		this.dataEnvioNotaFiscal = dataEnvioNotaFiscal;
	}

	public String getIdFuncEnvioNotaFiscal() {
		return idFuncEnvioNotaFiscal;
	}

	public void setIdFuncEnvioNotaFiscal(String idFuncEnvioNotaFiscal) {
		this.idFuncEnvioNotaFiscal = idFuncEnvioNotaFiscal;
	}
	...
	public Collection<GeSituacaoItem> getGeSituacaoItemCollection() {
		return geSituacaoItemCollection;
	}

	public void setGeSituacaoItemCollection(
			Collection<GeSituacaoItem> geSituacaoItemCollection) {
		this.geSituacaoItemCollection = geSituacaoItemCollection;
	}

	public GeNaturezaOperacao getIdNaturezaOperacao() {
		return idNaturezaOperacao;
	}

	public void setIdNaturezaOperacao(GeNaturezaOperacao idNaturezaOperacao) {
