 ...
 */
@Entity
@Table(name = "EMS_EID_BUFFER")
public class EmsEidBuffer implements Serializable {
    ...
    public EmsEidBuffer(Long buffer) {
        this.buffer = buffer;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof EmsEidBuffer)) {
            return false;
        }
        EmsEidBuffer other = (EmsEidBuffer) object;
