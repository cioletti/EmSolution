...
public class CrmPecas implements Serializable {
    ...
    @JoinColumns({
        @JoinColumn(name = "ID_CRM_SEGMENTO", referencedColumnName = "ID"),
        @JoinColumn(name = "ID_EMS_SEGMENTO", referencedColumnName = "ID_EMS_SEGMENTO")})
    @ManyToOne(optional = false)
    private CrmSegmento crmSegmento;
    ...
    public CrmSegmento getCrmSegmento() {
        return crmSegmento;
    }

    public void setCrmSegmento(CrmSegmento crmSegmento) {
        this.crmSegmento = crmSegmento;
    }
    ...
    public String toString() {
        return "com.emsolution.entity.CrmPecas[ id=" + id + " ]";
    }
