 ...
 */
@Entity
@Table(name = "EMS_PECAS_LOG")
public class EmsPecasLog implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof EmsPecasLog)) {
            return false;
        }
        EmsPecasLog other = (EmsPecasLog) object;
    ...
    public String toString() {
        return "com.emsolution.entity.EmsPecasLog[ id=" + id + " ]";
    }
